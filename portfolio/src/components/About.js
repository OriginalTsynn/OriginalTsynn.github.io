                ...
                <Grid className="contact-grid">
                    <Cell col={8}>
                        ...
                        <p style={{
                            ...
                            To that end, as of March 2019, I decided to try and follow my passion, and embark an a journey
                            to learn how to code at General Assembly.<br></br><br></br>

                            One of favorite technologies we learned there was React I'm not the greatest with it yet, but I see so much potential with it,
                            heck, this portfolio is done in React!  It's a really powerful tool I suggest most people interested in building websites learn early on.
                            <br></br>
                            <br></br>

                            In my free time, when not programming, I like to keep my senses sharp by passionately participating in gaming.  <br></br>
                            When not programming or gaming, I spend a lot of time working with my wonderful dogs-- Kage, CC and Shorty.
                    </p>
